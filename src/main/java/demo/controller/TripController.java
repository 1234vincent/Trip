...
public class TripController {
    ...
    public TravelDetail addTravelDetail(@PathVariable Long tripId, @RequestBody TravelDetail detail) {
        return tripService.addTravelDetail(tripId, detail);
    }

    @PutMapping("/details/{detailId}")
    public TravelDetail updateTravelDetail(@PathVariable int detailId, @RequestBody TravelDetail detail) {
        return tripService.updateTravelDetail(detailId, detail);
    }

    @DeleteMapping("/details/{detailId}")
    public void deleteTravelDetail(@PathVariable int detailId) {
        tripService.deleteTravelDetail(detailId);
    }
